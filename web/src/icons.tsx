...
export const IconUsers = (p: P) => (
  <svg {...base(p)}>
    ...
    <path d="M18.5 14.5A6.2 6.2 0 0 1 22 20" />
  </svg>
);

export const IconUsersPlus = (p: P) => (
  <svg {...base(p)}>
    <circle cx="9" cy="8" r="3.5" />
    <path d="M2 20a7 7 0 0 1 14 0" />
...
export const IconSticker = (p: P) => (
  <svg {...base(p)}>
    <path d="M15.5 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8l7-7V5a2 2 0 0 0-2-2z" />
    <path d="M14 21v-5a2 2 0 0 1 2-2h5" />
    <path d="M9 10h.01M14 10h.01" />
